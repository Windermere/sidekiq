...
module Sidekiq1
  ...
  module WebHelpers
    ...
    # This is a hook for a Sidekiq1 Pro feature.  Please don't touch.
    def filtering(*)
    end
    ...
    def processes
      @processes ||= Sidekiq1::ProcessSet.new
    end
    ...
    def retries_with_score(score)
      ...
      end.map { |msg| Sidekiq1.load_json(msg) }
    end
    ...
    def namespace
      @ns ||= Sidekiq1.redis { |conn| conn.respond_to?(:namespace) ? conn.namespace : nil }
    end
    ...
    def environment_title_prefix
      environment = Sidekiq1.options[:environment] || ENV['RAILS_ENV'] || ENV['RACK_ENV'] || 'development'

      "[#{environment.upcase}] " unless environment == "production"
    end

    def product_version
      "Sidekiq1 v#{Sidekiq1::VERSION}"
    end
