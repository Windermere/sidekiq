...
module Sidekiq2
  ...
  module WebHelpers
    ...
    # This is a hook for a Sidekiq2 Pro feature.  Please don't touch.
    def filtering(*)
    end
    ...
    def processes
      @processes ||= Sidekiq2::ProcessSet.new
    end
    ...
    def retries_with_score(score)
      ...
      end.map { |msg| Sidekiq2.load_json(msg) }
    end
    ...
    def namespace
      @ns ||= Sidekiq2.redis { |conn| conn.respond_to?(:namespace) ? conn.namespace : nil }
    end
    ...
    def environment_title_prefix
      environment = Sidekiq2.options[:environment] || ENV['RAILS_ENV'] || ENV['RACK_ENV'] || 'development'

      "[#{environment.upcase}] " unless environment == "production"
    end

    def product_version
      "Sidekiq2 v#{Sidekiq2::VERSION}"
    end
